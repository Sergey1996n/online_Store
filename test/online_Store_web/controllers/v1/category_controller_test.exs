defmodule Online_StoreWeb.V1.CategoryControllerTest do
  ...
  test "show/2 returns list products category", %{conn: conn} do
    ...
    response =
      conn
      |> get(category_path(conn, :show, category_1), attrs)
      |> json_response(200)
  ...
  test "show/2 returns list products category sort", %{conn: conn} do
    ...
    response =
      conn
      |> get(category_path(conn, :show, category, %{order: 1}), attrs)
      |> json_response(200)
  ...
  test "show/2 returns list products category filter", %{conn: conn} do
    ...
    response =
      conn
      |> get(category_path(conn, :show, category, %{from: 30000, to: "sdfgsfg"}))
      |> json_response(200)
